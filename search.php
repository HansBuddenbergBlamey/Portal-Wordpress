	...
	<div class="page-content-title-wrapper">
		...
		<div class="wrap_1280">
			...
			<?php if (have_posts()) : ?>
				...
				<h2 class="page-content-title">Resultados de la búsqueda para: <?php echo get_search_query(); ?></h2>
									...
									<div class="blog-page-content">
										...
										<?php if (has_post_thumbnail()) : ?>
											...
											<?php else : ?>
                                                ...
                                                Posteado en <?php the_date(get_option('date_format')); ?> a las <?php the_time(get_option('time_format')); ?> por <?php the_author_posts_link(); ?>
								...
								<?php endwhile; ?>
									...
									<?php else : ?>
										...
										<article class="no-posts">
											...
											<h1>Lo sentimos, no hay resultados con este término de búsqueda..</h1>
