                        ...
                        <h2 class="inner-title"><?php the_title(); ?></h2>
                            ...
                            <div class="category-post">
                                ...
                                <h6 class="article-meta-extra">
                                    ...
                                    Posteado el <?php the_date(get_option('date_format')); ?> a las <?php the_time(get_option('time_format')); ?> | <?php the_category('  |  '); ?> | <?php the_author_posts_link(); ?>
                    ...
                    <div class="social-share clearfix">
                        ...
                        <div class="author-box">
                            ...
                            <div class="author-info col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                ...
                                <h5 class="author-name">Autor: <?php echo get_the_author_meta('display_name'); ?></h5>
                                
                                <p><?php echo get_the_author_meta('description'); ?></p>
                                
                                <h6>Sitio: <a href="<?php echo get_the_author_meta('user_url'); ?>" title=""><?php echo get_the_author_meta('user_url'); ?></a></h6>
